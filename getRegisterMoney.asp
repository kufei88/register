	...
	if result = 0 then
		...
		if oldprice > newprice then
		  ...
		  if jsmoney - (newprice - oldprice) >= -taskmoney/2 then
			response.write "{""state"":1,""money"":"&newprice - oldprice&",""discount"":"&discount&",""taskmoney"":"&taskmoney&"}"
		  else
		    response.write "{""state"":4,""balance"":"&jsmoney - (newprice - oldprice)&",""jsmoney"":"&jsmoney&",""taskmoney"":"&taskmoney&"}"
		  end if
		end if
