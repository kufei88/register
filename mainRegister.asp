        ...
        <form id="ff" method="post">
            <table cellpadding="5">
				<tr>
					<td>用户:</td>
                    <td>
						<input name="company"  class="easyui-combobox" id="company"
					data-options="valueField:'username',textField:'company',url:'getCompany.asp'" ></input>
					</td>
				</tr>
                <tr>
                    <td>软件:</td>
                    <td><select class="easyui-combobox" id="state" name="state" style="width:200px;">
                ...
                <tr>
                    <td>加密狗号:</td>
                    <td><input class="easyui-numberbox"  name="dognumber" id="dognumber" readonly   ></input></td>
                </tr>
                <tr>
                    <td>客户:</td>
				...
				<tr>
                    <td>老软件:</td>
                    <td><input class="easyui-textbox"  name="oldversion" id="oldversion" readonly   ></input> 
					站点:<input class="easyui-textbox"  name="oldnumber" id="oldnumber" readonly   ></td>
                </tr>
				<tr>
                    <td>新软件:</td>
                    <td><input class="easyui-textbox"  name="newversion" id="newversion" readonly   ></input>
					站点:<input class="easyui-textbox"  name="newnumber" id="newnumber" readonly   ></td>
                </tr>
				<tr>
                    <td>注册码:</td>
                    <td>
	...
	function getCode(){
		...
		$.post('getDecode.asp?registerCode=' + $('#code').val(), function(msg) {
				...
				if (msg == 'error')
				{
					...
					$('#dognumber').numberbox('setValue',msg.dogCode);
		...
		$.post('getMainRegisterMoney.asp',{oldversion:$('#oldversion').val()
			,newnumber:$('#newnumber').val(),oldnumber:$('#oldnumber').val(),
			dogCode:$('#dognumber').val(),newversion:$('#newversion').val(),
			client:$('#company').combobox('getValue')},
			function(msg){
