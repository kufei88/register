...
<body>
        ...
        <table id="dg" title="试用注册查询" class="easyui-datagrid" style="width:100%;height:550px"
                url="getTrialQuery.asp"
                toolbar="#toolbar" 
                rownumbers="true" fitColumns="true" singleSelect="true" pagination="true" >
            <thead>
                <tr>
					<th field="company"  width="30">代理商</th>
				    <th field="clientName"  width="50">客户名称</th>
					<th field="macAddress" width="50">mac地址</th>
                    <th field="useDay" width="50">试用天数</th>
                    <th field="trialDate" width="50">注册日期</th>
