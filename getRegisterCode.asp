...
<%
	...
	sql = "insert into registerhistory (username,registerdate,dognumber,client,oldversion,newversion,discount,consumeJS,ip,oldnumber,newnumber,registerCode,jsmoney,memo)"_
		&" values ('"&username&"',getdate(),'"&mid(dogCode,1,5)&"','"&clinet&"','"&oldversion&"','"&newversion&"',"&discount&","&registerCharge&",'"&getipadd()&"',"_
		&oldnumber&","&newnumber&",'"&registerCode&"',"&jsmoney-registerCharge&",'"&remark&"')"
